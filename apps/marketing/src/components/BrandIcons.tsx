...
// full 178 width and sit vertically centered, so the square viewBox renders the mark at its
// maximum size inside square icon boxes.
export function PrimeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 178 178" fill="none" className={className} aria-hidden="true">
      <path
        fill="currentColor"
